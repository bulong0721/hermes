...
public class AddressController {
    ...
    @RequestMapping(value = "/address/province/list4Select", method = RequestMethod.GET)
    @ResponseBody
    ...
    @RequestMapping(value = "/address/city/listByProvince", method = RequestMethod.GET)
    @ResponseBody
    ...
    @RequestMapping(value = "/address/city/listByProvince4Select", method = RequestMethod.GET)
    @ResponseBody
    ...
    @RequestMapping(value = "/address/district/listByCity", method = RequestMethod.GET)
    @ResponseBody
    ...
    @RequestMapping(value = "/address/district/listByCity4Select", method = RequestMethod.GET)
    @ResponseBody
